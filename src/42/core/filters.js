...
types.string = {
  toCamelCase: MANIPULATION,
  toCapitalCase: MANIPULATION,
  toConstantCase: MANIPULATION,
  toHeaderCase: MANIPULATION,
  toKebabCase: MANIPULATION,
  toLowerCase: MANIPULATION,
  toNocaseCase: MANIPULATION,
  toPascalCase: MANIPULATION,
  toSentenceCase: MANIPULATION,
  toSnakeCase: MANIPULATION,
  toTitleCase: MANIPULATION,
  toUpperCase: MANIPULATION,
