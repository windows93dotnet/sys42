...
function base64Slice(buf, start, end) {
  if (start === 0 && end === buf.length) {
    return base64.fromArrayBuffer(buf)
  }

  return base64.fromArrayBuffer(buf.slice(start, end))
}
...
const errors = {}
function registerError(sym, getMessage, Base) {
...
function base64clean(str) {
  ...
  str = str.trim().replaceAll(INVALID_BASE64_RE, "")
...
function base64ToBytes(str) {
  return new Uint8Array(base64.toArrayBuffer(base64clean(str)))
}
