...
/* eslint-disable */
//! Copyright 2018 The Chromium Authors. Apache License 2.0
// @src https://github.com/WICG/virtual-scroller/tree/virtual-content-streaming
...
export const RepeatsAndScrolls = (Superclass) =>
  class extends Repeats(Superclass) {
    constructor(config) {
      super()
      this._num = 0
      this._first = -1
    ...
    _containerSizeChanged(size) {
      if (this.pauseSizeChange === true) return
