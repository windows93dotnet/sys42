...
test.tasks(
  [
    ...
    task({ actual: 0.913_011_109_901_741_7, expected: "lns1x4g9qvh0" }),
    task({ actual: -1, expected: "xx9ec46jeljt" }),
    task({ actual: Infinity, expected: "pq0tumj87gs7" }),
    task({ actual: [], expected: "yirvnbjycpkj" }),
    task({ actual: {}, expected: "osxxeiz0spdr" }),
    task({ actual: { a: 1 }, expected: "p1wv8xyl7h8h" }),
    task({ actual: { a: "hello" }, expected: "z1fu6fr0nllv" }),
    task({ actual: [1], expected: "s87368yjmyv7" }),
